...
`docs/ARCHITEKTUR_V3.md` (Plan; Phasen 0–2 inkl. ScriptRegistry und
Data-Plane-Kern sind implementiert), `docs/DATA_PLANE.md` (grosse Daten,
DataRef-Handles, Frame-Budget), `docs/BOTTLENECKS.md`,
