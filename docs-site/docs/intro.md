...
Für Exporte beschreibt [Export-Prüfung](./export-check) die Unterschiede
zwischen Desktop und Web. Große lokale Daten behandelt
[Hochleistungspfade](./hochleistungspfade); der Standardweg bleibt
WebSocket plus DataRef/File-Transport.
